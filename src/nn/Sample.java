...
public class Sample {
    double[] features;
    int cls;
    String originalLine; // Nuovo campo per tenere traccia della riga CSV
    ...
    */
    public Sample(String line) {
        this.originalLine = line; // Salvo la riga originale
    ...
    */
    ...
    /*
        Metodo per ottenere la riga originale del campione.
        Utile per il debug o per la visualizzazione dei dati originali.
    */
